...
export const Home = () => {
        ...
        const handleFavorites = () => {
                if (!dogs.favorites.includes(dogs.name)) {
                        setDogs.addFavorite(dogs.name)
                }
                else {
                        setDogs.removeFavorite(dogs)
                }
        }
                                                                ...
                                                                <div key={dog.id}>
                                                                        ...
                                                                        <div className="card" style={{ width: "18rem" }}>
                                                                                ...
                                                                                <div className="card-body">
                                                                                        ...
                                                                                        <button className="btn btn btn-text-color mx-4" onClick={() => handleFavorites()}>
