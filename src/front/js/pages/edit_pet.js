...
export const Edit_pet = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (success) {
            ...
            setWeight("")
            setAvatar(null)
            alert("Dog info successfully edited!");
            navigate("/private");
        } else {
            alert("An error ocurred while editing your dog's info. Please, try again later.")
        }
    };

    return (
        <form className="editPetForm row g-4">
            ...
            <div className="col-md-12 text-center">
                <button
                    ...
                    type="submit"
                    className="btn btn-primary btn-lg saveButton"
                >
                    Save
                </button>
                <Link to={`/private`}>
