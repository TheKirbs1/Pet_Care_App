    ...
    return (
        <div className="pt-4">
            ...
            <div className="d-flex justify-content-center align-items-center vstack px-3">
                <h1 className="text-warning text-decoration-underline">Mission Statement</h1>
            ...
            <div>
            <h1 className="d-flex justify-content-center align-items-center text-warning my-3 text-decoration-underline">MEET THE DEVELOPERS</h1>
            </div>
            ...
            <div className="container">
                ...
                <div className="d-flex justify-content-center align-items-center  vstack">
                    <h1 className="text-warning text-decoration-underline">CONTACT US!</h1>
