            ...
            <div className="profile-container">
                <div className="row justify-content-center">
                    ...
                    <div className="col-md-4">
                        <div className="right-buttons">
                            ...
                            <button className="btn text-primary switch-button">
                ...
                <div className="row">
                    <div className="col-md">
                        <div className="dropdown reminders-button">
                            <button className="btn btn-info btn-lg  dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Reminders
                            </button>
                            <ul className="dropdown-menu">
                                <li><a className="dropdown-item" href="#">Vaccinations</a></li>
                                <li><a className="dropdown-item" href="#">Medications</a></li>
                                <li><a className="dropdown-item" href="#">Dog Grooming</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
